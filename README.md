...
- **全文搜索** — 中英文混合搜索，支持 Ctrl+K 全局搜索
- **专题协作 (WikiProject)** — 创建协作项目，看板任务管理，成员邀请，讨论区实时聊天，多人协作编辑
- **创意板** — 看板+列表双视图，28→35种话题筛选，多人认领，评论讨论，短ID引用
- **主题门户** — 按35个分类浏览冰山图与创意，每个主题独立子页面
- **精选内容** — 管理员甄选优质冰山图集中展示
- **排行榜** — 热门/高赞/用户三标签页，时间段筛选，前三名Hero展示区
- **质量分与成就** — 121个成就，15个分类，支持全量复核检测
- **词条标签系统** — 169个预设标签，分标记/内容/来源三大类，emoji分类折叠
- **社区审核** — 内容提交→编辑审核→发布，含提交前检查清单
- **RBAC 权限系统** — USER / CONTRIBUTOR / EDITOR / MODERATOR / ADMIN / FOUNDER
- **社区治理** — RfA 编辑选举、管理员弹劾、举报处理、反馈跟踪
- **双色主题** — 暗色终端绿 + 浅色模式，可选CRT复古扫描线效果
- **导出图片** — 一键生成含水印和二维码的PNG信息图
